...
(1, 1, 35, 'NORMAL', '2026-04-25 08:00:00', 30),
(1, 2, 15, 'NORMAL', '2026-04-25 08:00:00', 12),
(1, 3, 80, 'NORMAL', '2026-04-28 06:00:00', 60),
...
INSERT INTO store_inventory (store_idx, product_idx, count, status, manufactured_date, avg_stock) VALUES
(2, 1, 8, 'LOW', '2026-04-23 08:00:00', 30),
...
(2, 12, 3, 'CRITICAL', '2026-04-24 08:00:00', 8),
...
(3, 3, 50, 'NORMAL', '2026-04-28 06:00:00', 45),
...
-- ============================================================
-- 10. PosStoreInventory (POS 시스템 재고 - 강남, 홍대만)
-- ============================================================
INSERT INTO pos_store_inventory (store_idx, product_idx, count, status, manufactured_date) VALUES
(1, 1, 35, 'NORMAL', '2026-04-25 08:00:00'),
(1, 3, 80, 'NORMAL', '2026-04-28 06:00:00'),
...
(2, 1, 8, 'LOW', '2026-04-23 08:00:00'),
(2, 3, 18, 'LOW', '2026-04-27 06:00:00'),
(2, 12, 3, 'CRITICAL', '2026-04-24 08:00:00'),

...
export const useNotificationStore = defineStore('notification', () => {
  const notifications = ref([
    // ADMIN 알림
    {
      ...
      type: 'order_new',
      title: '새 발주 요청',
      body: '판교테크노밸리점에서 에스프레소 원두 외 3종 발주를 요청했습니다.',
    ...
    },
    {
      ...
      type: 'order_new',
      title: '새 발주 요청',
      body: '부산센텀점에서 우유(1L) 외 2종 발주를 요청했습니다.',
    ...
    },
    {
      ...
      type: 'low_stock',
      title: '재고 부족 경고',
      body: '바닐라 시럽(P300) 재고가 최소 기준(30병) 이하입니다. 현재 재고: 22병.',
    ...
    },
    {
      ...
      type: 'auto_order',
      title: '자동발주 제안',
      body: '에스프레소 원두(P101) 재고가 기준치 이하입니다. 자동발주 승인이 필요합니다.',
    ...
    // STORE_OWNER 알림
    {
      ...
      type: 'order_approved',
      title: '발주 승인',
      body: '요청하신 발주(ORD-042)가 본사에서 승인되었습니다. 납품 예정: 04-17.',
    ...
    },
    {
      ...
      title: '배송 상태 변경',
      body: '발주 ORD-040 배송이 출발했습니다. 예상 도착: 오늘 오후 3시.',
    ...
    },
    {
      ...
      type: 'order_rejected',
      title: '발주 반려',
      body: '요청하신 발주(ORD-041)가 반려되었습니다. 사유: 재고 충분. 본사에 문의하세요.',
    ...
    },
    {
      ...
      type: 'auto_order',
      title: '자동발주 제안',
      body: '종이컵(M) 재고가 부족합니다. 자동발주 200개를 신청하시겠습니까?',
    ...
    },
    {
      ...
      type: 'settlement',
      title: '정산 완료',
      body: '2026-04 월 정산이 완료되었습니다. 청구 금액: ₩12,500,000.',
